  ...
  async sendAppointmentRescheduled(params: {
    ...
    await Promise.all([
      send({
        ...
        message: `Your appointment with Dr. ${params.doctorName} has been rescheduled to ${dateLabel}. Waiting for the doctor to confirm.`,
        link: '/appointments',
      ...
      send({
        userId: params.doctorId,
        type: 'appointment_rescheduled',
        title: 'Reschedule Request — Confirmation Needed',
        message: `${params.patientName} rescheduled their appointment to ${dateLabel}. Please confirm or reject the new time.`,
        link: '/doctor/appointments',
        data: { appointmentId: params.newAppointmentId },
      }),
    ]);
